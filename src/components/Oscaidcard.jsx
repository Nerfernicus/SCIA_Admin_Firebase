 ...
 * OSCAIdCard
 * Props:
 *   mode        : "digital" | "physical"  — controls "DIGITAL ID" badge visibility
 *   name        : string
 *   address     : string  (can include line breaks with \n)
      ...
      <div className="osca-card osca-card-back">
        ...
        <div className="back-body">
          <ol className="benefits-list">
            ...
            <li>
              12% VAT-exemption on the purchase of goods &amp; services which are entitled to the
              20% discount
            </li>
            <li>
              5% discount for the monthly utilization of water &amp; electricity, provided that the
              water &amp; electricity meter bases are under the name of the senior citizens.
            </li>
          </ol>
